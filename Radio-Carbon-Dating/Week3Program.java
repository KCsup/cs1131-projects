...
public class Week3Program {
    ...
    /**
     * Given the age of an artifact in years, return the percent of C14 left
     * in it. Here a percentage is a double in the range [0.0, 1.0].
    ...
    double radiocarbonPercent ( int age ) {
        // Rounding the output to 2 decimal places for proper percentage
        // parsing. See method definition below.
     ...
     * organism died. The date is the current year minus the age of
     * the artifact.
     * Your result should be truncated, not rounded.
    ...
    * @param decimalPlaces The number of decimal places to round to. Ex. 2
    * will round the hundreths place.
    ...
    */
    ...
    public static void main ( String [ ] args ) {
        ...
        System.out
            .printf( "radiocarbonPercent( %d ) = %f%%. ", age, percentage );
        ...
        System.out.printf(
            "radiocarbonAge( %f ) = %d years old. ", percentage, age
        );
        ...
        age = 1845;
        System.out.printf(
            "radiocarbonDate( %f ) = the year %d. ", percentage, year
        );
